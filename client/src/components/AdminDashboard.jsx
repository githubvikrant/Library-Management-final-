    ...
    <>
      <main className="relative flex-1 p-6 pt-28">
        ...
        <div className="flex flex-col-reverse xl:flex-row">
          ...
          <div className="flex flex-[4] flex-col gap-4 lg:gap-16 lg:px-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
            ...
            <div className="hidden xl:flex bg-white p-1 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-40 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
